...
ejercicio_i = sql^"""
                  ...
                  """
#ejercicio_i.to_excel(r'D:\Python\Labo de datos\TP 1\ej1.xlsx', index=False)
...
ejercicio_ii = sql^"""
                   ...
                   """
#ejercicio_ii.to_excel(r'D:\Python\Labo de datos\TP 1\ej2.xlsx', index=False)
#---------------------------------------------Ejercicio 4----------------------------------------------
pais_sede= sql^"""
...
ejercicio_iv = sql^"""
                   ...
                   """
#ejercicio_iv.to_excel(r'D:\Python\Labo de datos\TP 1\ej4.xlsx', index=False)
#---------------------------------------------Ejercicio 3----------------------------------------------
ejercicio_iii = sql^"""
                   ...
                   """
#ejercicio_iii.to_excel(r'D:\Python\Labo de datos\TP 1\ej3.xlsx', index=False)
